...
public class Max_product_subarray {
	...
	static/*
		 * Returns the product of max product subarray. Assumes that the given
		 * array always has a subarray with product more than 1
		 */
	int maxSubarrayProduct(int arr[], int n) {
		...
		for (int i = 0; i < n; i++) {
			...
			System.out.println("Max ending here is:" + max_ending_here);
			System.out.println("Min ending here is:" + min_ending_here);
