...
public class LargestBSTInBinaryTree {
    ...
    private MinMax largest(Node root){
        ...
        MinMax leftMinMax = largest(root.leftChild);
        MinMax rightMinMax =largest(root.rightChild);
        ...
        m.min = root.leftChild != null ? leftMinMax.min : root.data;
  
        //if root.right is null then set root.data as max else
        //take max of right side as max.
        m.max = root.rightChild != null ? rightMinMax.max : root.data;
